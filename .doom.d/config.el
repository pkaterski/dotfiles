...
(setq user-full-name "Parashkev Katerski"
      user-mail-address "pkaterski@gmail.com")
...
(require 'vterm)
(setq vterm-timer-delay 0.003)
(define-key vterm-mode-map (kbd "M-<backspace>") 'vterm-send-meta-backspace)
